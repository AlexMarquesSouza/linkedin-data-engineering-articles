...
> Artigo com implementação · Compatibilidade de bibliotecas
...
O texto recuperado está em [artigo-linkedin.md](artigo-linkedin.md). A versão curta para revisão está em [post-linkedin.md](post-linkedin.md). A implementação isola o conceito **compatibilidade de bibliotecas** usando um cenário JSON seguro, uma função Python, relatório e teste.
...
cd "0013-fabric-runtime-2-spark-4"
```
...
Compatibilidade de bibliotecas, configuração como dados, função determinística, cenário mínimo reproduzível, teste automatizado, rastreabilidade e distinção entre PoC e produção.
